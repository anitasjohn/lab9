...
//only looks at argv[1], argv[2]
int main(int argc, const char * argv[]) { //user can input number, example, 2 and 3 -- argc = n + 1; where n = 2
    int row, col;
    ...
    print_with_sum(m1); // m1 copies m2 values
    
    m2.sum_of_rows();
    m2.sum_of_cols();
    
    Matrix m3 = m2; //Matrix& operator= --- m3 copies m2
    
    m2.at(0, 0)= -5;
    m2.at(1, 1)= -15;
    m2.at(2, 2)= -25; //changing values in m2 //-25
